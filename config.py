...
LOGGER_ID = int(getenv("LOGGER_ID", -1003247086896))
OWNER_ID = int(getenv("OWNER_ID", 8411934017))
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+nKm51VhzCcszN2Q1")
...
API_KEY = getenv("API_KEY", 'xbit_UN3KYFZCGTS8L4138B6T9C') # youtube song api key, generate free key or buy paid plan from panel.thequickearn.xyz
...
TELEGRAM_AUDIO_URL = "https://files.catbox.moe/ts84ew.jpg"
TELEGRAM_VIDEO_URL = "https://graph.org/file/61fc4317009e56fbe49d5-f33bbf770248706772.jpg"
